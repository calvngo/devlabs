...
![Cloud9](https://github.com/aws-samples/amazon-macie-detect-sensitive-data-lab/blob/main/images/Cloud9.jpg)

Then select the Cloud9 environment named `Macie Devlab (Level 100), and click the Open IDE button for you to enter the IDE

![Open IDE](https://github.com/aws-samples/amazon-macie-detect-sensitive-data-lab/blob/main/images/step2-open-cloud9-ide.jpg)
...
![Terminal](https://github.com/aws-samples/amazon-macie-detect-sensitive-data-lab/blob/main/images/step3-terminal-output.png)
...
![Macie Job](https://github.com/aws-samples/amazon-macie-detect-sensitive-data-lab/blob/main/images/step4-create-Macie-job.jpg)
...
![Macie Job](https://github.com/aws-samples/amazon-macie-detect-sensitive-data-lab/blob/main/images/step5-select-bucket.jpg)
...
![Macie Job](https://github.com/aws-samples/amazon-macie-detect-sensitive-data-lab/blob/main/images/step6-review-buckets.png)
...
![Macie Job](https://github.com/aws-samples/amazon-macie-detect-sensitive-data-lab/blob/main/images/step7-refine-scope.jpg)
...
![Macie Job](https://github.com/aws-samples/amazon-macie-detect-sensitive-data-lab/blob/main/images/step8-selecting-managed-identifiers.png)
...
![Macie Job](https://github.com/aws-samples/amazon-macie-detect-sensitive-data-lab/blob/main/images/step9-custom-data-identifier.png)

Now we'll enter a job name and optional description

![Macie Job](https://github.com/aws-samples/amazon-macie-detect-sensitive-data-lab/blob/main/images/step10-general-settings.png)
...
![Macie Job](https://github.com/aws-samples/amazon-macie-detect-sensitive-data-lab/blob/main/images/step11-submit.jpg)
...
![Macie Findings](https://github.com/aws-samples/amazon-macie-detect-sensitive-data-lab/blob/main/images/step12-Findings.jpg)
...
![Macie Findings](https://github.com/aws-samples/amazon-macie-detect-sensitive-data-lab/blob/main/images/step13-overview.jpg)
...
![Macie Findings](https://github.com/aws-samples/amazon-macie-detect-sensitive-data-lab/blob/main/images/step14-detail-findings.jpg)
...
# Survey Link
Thank you for participating in this lab. Please leave us feedback to let us know how we did and for us to improve in future labs. If the QR code below doesn't work, you can click on the link [here](https://eventbox.dev/survey/7TVOCNT).

![Survey QR Code](/qr/macie-detect.png)
