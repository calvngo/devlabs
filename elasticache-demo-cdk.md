...
![00_architecture](https://github.com/aws-samples/amazon-elasticache-demo-using-aws-cdk/blob/main/images/00_architecture.png)
...
![04_deploy](https://github.com/aws-samples/amazon-elasticache-demo-using-aws-cdk/blob/main/images/01_deploy.png)



You can see the progress of the deployment on the terminal. It takes around 10 to 15 minutes to deploy the stack.

![05_deploy](https://github.com/aws-samples/amazon-elasticache-demo-using-aws-cdk/blob/main/images/02_deploy.png)
...
![06_deploy](https://github.com/aws-samples/amazon-elasticache-demo-using-aws-cdk/blob/main/images/03_deploy.png)
...
![07_check_cfn](https://github.com/aws-samples/amazon-elasticache-demo-using-aws-cdk/blob/main/images/04_check_cfn.png)
...
![08_check_cfn_outputs](https://github.com/aws-samples/amazon-elasticache-demo-using-aws-cdk/blob/main/images/05_check_cfn_outputs.png)
...
![09_check_ec2](https://github.com/aws-samples/amazon-elasticache-demo-using-aws-cdk/blob/main/images/06_check_ec2.png)



On the Amazon RDS console, verify if the MySQL instance was created and is available.

![10_check_rds](https://github.com/aws-samples/amazon-elasticache-demo-using-aws-cdk/blob/main/images/07_check_rds.png)



On the ElastiCache console, verify if the Redis cluster is available.

![11_check_redis](https://github.com/aws-samples/amazon-elasticache-demo-using-aws-cdk/blob/main/images/08_check_redis.png)
...
![ssm-02](https://github.com/aws-samples/amazon-elasticache-demo-using-aws-cdk/blob/main/images/10-ssm.png)



3. On the **Session Manager** tab, choose **Connect**.

![ssm-03](https://github.com/aws-samples/amazon-elasticache-demo-using-aws-cdk/blob/main/images/11-ssm.png)
...
![ssm-04](https://github.com/aws-samples/amazon-elasticache-demo-using-aws-cdk/blob/main/images/12-ssm.png)
...
![ssm-05](https://github.com/aws-samples/amazon-elasticache-demo-using-aws-cdk/blob/main/images/13-ssm.png)
...
![12_app_home](https://github.com/aws-samples/amazon-elasticache-demo-using-aws-cdk/blob/main/images/14_app_home.png)
...
![13_app_query_mysql](https://github.com/aws-samples/amazon-elasticache-demo-using-aws-cdk/blob/main/images/15_app_query_mysql.png)



You can review the time it took to run the query. Now let's try to query the cache by choosing **Query Cache**.

![14_app_query_cache1](https://github.com/aws-samples/amazon-elasticache-demo-using-aws-cdk/blob/main/images/16_app_query_cache1.png)
...
![15_app_query_cache2](https://github.com/aws-samples/amazon-elasticache-demo-using-aws-cdk/blob/main/images/17_app_query_cache2.png)
...
Thank you for participating in this lab. Please leave us feedback to let us know how we did and for us to improve in future labs. If the QR code below doesn't work, you can click on the link [here](https://eventbox.dev/survey/06696LI).

![Survey QR Code](/qr/elasticache-demo.png)
