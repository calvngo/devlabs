...
![Cloud9 Search](https://github.com/aws-samples/aws-anz-devlabs-ecs-fis/blob/main/document/images/cloud9_search.png)
...
![Create Experiment Template Home](https://github.com/aws-samples/aws-anz-devlabs-ecs-fis/blob/main/document/images/1-FIS-Create-Home.png "Create Experiment Template")
...
![Create Experiment Template Basic](https://github.com/aws-samples/aws-anz-devlabs-ecs-fis/blob/main/document/images/1-FIS-Create-Exp.png "Create Experiment Template First part")
...
![FIS Action](https://github.com/aws-samples/aws-anz-devlabs-ecs-fis/blob/main/document/images/1-FIS-Action.png "FIS Action")
...
![FIS Target](https://github.com/aws-samples/aws-anz-devlabs-ecs-fis/blob/main/document/images/1-FIS-Target.png "FIS Target")
...
![FIS Start](https://github.com/aws-samples/aws-anz-devlabs-ecs-fis/blob/main/document/images/1-FIS-ExpTemplate-Start.png "FIS Start")
...
![ASG](https://github.com/aws-samples/aws-anz-devlabs-ecs-fis/blob/main/document/images/1-FIS-ASG.png "ASG Update")
...
6. For IAM Role, choose the IAM Role (from drodown) that was created as part of CloudFormation. The IAM Role name will be starting with 'EcsFisStack-fisrole....'
![Create Experiment Template Basic](https://github.com/aws-samples/aws-anz-devlabs-ecs-fis/blob/main/document/images/2-FIS-Create-Exp.png "Create Experiment Template First part")
...
11. Click on Save at the top of Actions menu. 
![FIS Action](https://github.com/aws-samples/aws-anz-devlabs-ecs-fis/blob/main/document/images/2-FIS-Action.png "FIS Action")
...
![FIS Target](https://github.com/aws-samples/aws-anz-devlabs-ecs-fis/blob/main/document/images/2-FIS-Target.png "FIS Target")
...
2. In the next page, click on Start Experiment. 
3. In the popup, enter 'start' and confirm.
![FIS Start](https://github.com/aws-samples/aws-anz-devlabs-ecs-fis/blob/main/document/images/2-FIS-ExpTemplate-Start.png "FIS Start")
...
![ECS Cluster](https://github.com/aws-samples/aws-anz-devlabs-ecs-fis/blob/main/document/images/2-ECS-Cluster.png "ECS Cluster")
3. Choose the Services tab and click on the service name 'sample-app-service'. 
![ECS Service](https://github.com/aws-samples/aws-anz-devlabs-ecs-fis/blob/main/document/images/2-ECS-Service.png "ECS Service")
...
![ECS Events](https://github.com/aws-samples/aws-anz-devlabs-ecs-fis/blob/main/document/images/2-ECS-Events.png "ECS Events")

</details>


### Conclusion and survey
Thank you for participating in this lab. Please leave us feedback to let us know how we did and for us to improve in future labs. If the QR code below doesn't work, you can click on the link [here](https://eventbox.dev/survey/50M60TN).

![Survey QR Code](/qr/ecs-fis.png)
